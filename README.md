...
initscript {
    ...
    dependencies {
        classpath 'com.gemnasium:gradle-plugin:1.0.1'  // needs to refer to a specific version, no wildcards or meta-versions allowed
    }
}
...
- [README.md](README.md)
   ...
   initscript {
       ...
       dependencies {
           // change the following version
           classpath 'com.gemnasium:gradle-plugin:1.0.1'
       }
   }
   ```
